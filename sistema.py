...
class SistemaMecanica:
    ...
    def carregar_dados_exemplo(self):
        ...
        # Criar clientes
        cliente1 = atendente1.criar_cliente(
        ...
        cliente2 = atendente1.criar_cliente(
        ...
        cliente3 = atendente1.criar_cliente(
        ...
        # Criar veículos
        veiculo1 = atendente1.criar_veiculo(
            placa="ABC1234",
        ...
        veiculo2 = atendente1.criar_veiculo(
            placa="XYZ9876",
        ...
        veiculo3 = atendente1.criar_veiculo(
            placa="DEF5678",
        ...
        veiculo4 = atendente1.criar_veiculo(
            placa="GHI9012",
        ...
        os1 = atendente1.criar_ordem_servico(
            cliente=cliente1,
            veiculo=veiculo1,
        ...
        os2 = atendente1.criar_ordem_servico(
            cliente=cliente2,
            veiculo=veiculo3,
        ...
        os3 = atendente1.criar_ordem_servico(
            cliente=cliente3,
            veiculo=veiculo4,
